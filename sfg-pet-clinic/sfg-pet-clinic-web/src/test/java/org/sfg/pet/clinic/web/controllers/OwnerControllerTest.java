package org.sfg.pet.clinic.web.controllers;
...
import diana.springframework.sfgpetclinic.controller.OwnersController;
...
class OwnerControllerTest {
	...
	void displayOwner() throws Exception {
		...
		mockMvc.perform(get("/owners/123")).andExpect(status().isOk())
				.andExpect(view().name("owners/ownerDetails")).andExpect(
